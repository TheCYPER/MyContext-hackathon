...
export function EntityInspector({ entityId, summary, revision, entities, graphNodeIds, onOpenEntity, onFocusGraph, onOpenChange }: { entityId: string | null; summary?: Entity; revision: string; entities: Entity[]; graphNodeIds: string[]; onOpenEntity: (id: string) => void; onFocusGraph: (id: string) => void; onOpenChange: (open: boolean) => void }) {
