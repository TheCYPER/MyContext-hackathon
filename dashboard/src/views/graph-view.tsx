...
export function GraphView({
  ...
  const relations = useMemo(() => {
    ...
    return buildLegacyRelations(snapshot.entities, snapshot.graph.edges).filter(
    ...
    return (
      <section>
        ...
        <EmptyState
          ...
          description="The graph only uses visible canonical frontmatter links."
        />
      </section>
    );
  ...
  const trace = () => {
    ...
    setPath(
      targetId ? shortestPath(nodes, relations, focusId, targetId) : null,
    );
  };
      ...
      <section>
        ...
        <div className="border bg-card p-4 sm:p-5">
          ...
          <p className="mt-4 text-xs leading-relaxed text-muted-foreground">
            The aperture highlights at most two hops through visible legacy
            frontmatter links. It explains reachability, not meaning.
          </p>
